...
?>
<div class="fl-sidebar fl-sidebar-<?php echo $position; ?> fl-sidebar-display-<?php echo $display; ?> col-lg-<?php echo $size; ?>" itemscope="itemscope" itemtype="https://schema.org/WPSideBar">
