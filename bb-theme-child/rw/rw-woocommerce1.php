...
add_image_size( 'woocommerce_medium_product', 300, 360 ); // resize the image proportionally
add_image_size( 'woocommerce_full_product', 490, 680 ); // resize the image proportionally
*/
